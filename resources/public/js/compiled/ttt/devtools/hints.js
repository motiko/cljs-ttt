...
var file = cljs.core.get.call(null,map__33680__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33680__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33680__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e33679){var _e = e33679;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___33682 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___33682)){
var seen_errors_33683 = temp__4655__auto___33682;
if(cljs.core.truth_(seen_errors_33683.has(self))){
} else {
seen_errors_33683.add(self);

var temp__4657__auto___33684 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___33684)){
var sense_33685 = temp__4657__auto___33684;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_33685)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1493511398611