...
var o__30247__auto___33669 = (function (){var o__30247__auto__ = (function (){var o__30247__auto__ = Promise;
return goog.object.get(o__30247__auto__,"resolve").call(o__30247__auto__);
})();
return goog.object.get(o__30247__auto__,"then").call(o__30247__auto__,callback);
})();
goog.object.get(o__30247__auto___33669,"catch").call(o__30247__auto___33669,devtools.async.rethrow_outside_promise);
...
var G__33671_33672 = Error;
var target__30266__auto___33673 = G__33671_33672;
if(cljs.core.truth_(target__30266__auto___33673)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__33671_33672)].join('')),cljs.core.str("\n"),cljs.core.str("target__30266__auto__")].join('')));
}

goog.object.set(target__30266__auto___33673,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1493511398555