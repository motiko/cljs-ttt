...
var args33408 = [];
var len__27315__auto___33414 = arguments.length;
var i__27316__auto___33415 = (0);
while(true){
if((i__27316__auto___33415 < len__27315__auto___33414)){
args33408.push((arguments[i__27316__auto___33415]));

var G__33416 = (i__27316__auto___33415 + (1));
i__27316__auto___33415 = G__33416;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox33411 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox33411 = (function (obj,header,style,tag,meta33412){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox33411.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33413,meta33412__$1){
var self__ = this;
var _33413__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox33411(self__.obj,self__.header,self__.style,self__.tag,meta33412__$1));
});

devtools.toolbox.t_devtools$toolbox33411.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33413){
var self__ = this;
var _33413__$1 = this;
return self__.meta33412;
});

devtools.toolbox.t_devtools$toolbox33411.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox33411.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox33411.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox33411.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox33411.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta33412","meta33412",1999008451,null)], null);
});

devtools.toolbox.t_devtools$toolbox33411.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox33411.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox33411";

devtools.toolbox.t_devtools$toolbox33411.cljs$lang$ctorPrWriter = (function (this__26846__auto__,writer__26847__auto__,opt__26848__auto__){
return cljs.core._write.call(null,writer__26847__auto__,"devtools.toolbox/t_devtools$toolbox33411");
});

devtools.toolbox.__GT_t_devtools$toolbox33411 = (function devtools$toolbox$__GT_t_devtools$toolbox33411(obj__$1,header__$1,style__$1,tag__$1,meta33412){
return (new devtools.toolbox.t_devtools$toolbox33411(obj__$1,header__$1,style__$1,tag__$1,meta33412));
});

}

return (new devtools.toolbox.t_devtools$toolbox33411(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1493511398289