...
var args30017 = [];
var len__27315__auto___30021 = arguments.length;
var i__27316__auto___30022 = (0);
while(true){
if((i__27316__auto___30022 < len__27315__auto___30021)){
args30017.push((arguments[i__27316__auto___30022]));

var G__30023 = (i__27316__auto___30022 + (1));
i__27316__auto___30022 = G__30023;
continue;
} else {
}
break;
...
var G__30020 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__30020,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__30020;
}
});
...
var len__27315__auto___30028 = arguments.length;
var i__27316__auto___30029 = (0);
while(true){
if((i__27316__auto___30029 < len__27315__auto___30028)){
args__27322__auto__.push((arguments[i__27316__auto___30029]));

var G__30030 = (i__27316__auto___30029 + (1));
i__27316__auto___30029 = G__30030;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq30025){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__30026,G__30027,seq30025__$2);
});
...
var line = cljs.core.get.call(null,map__30034__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30034__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__30034,map__30034__$1,file,line,column){
return (function (p1__30031_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__30031_SHARP_));
});})(map__30034,map__30034__$1,file,line,column))
...
var temp__4657__auto___30036 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___30036)){
var message_30037 = temp__4657__auto___30036;
cljs.core.println.call(null,message_30037);
} else {
}
...
var temp__4657__auto___30038 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___30038)){
var message_30039 = temp__4657__auto___30038;
cljs.core.println.call(null,message_30039);
} else {
}
...
var G__30049 = exception.stack;
var G__30049__$1 = (((G__30049 == null))?null:clojure.string.split_lines.call(null,G__30049));
var G__30049__$2 = (((G__30049__$1 == null))?null:cljs.core.get.call(null,G__30049__$1,depth));
if((G__30049__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__30049__$2);
}
} else {
...
var vec__30050 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__30050,(0),null);
var column = cljs.core.nth.call(null,vec__30050,(1),null);
var vec__30053 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__30053,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__30053,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__30053,(2),null);
...
var m__$1 = (function (){var G__30057 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__30057) {
case "fail":
...
var G__30063 = (function (){var G__30062 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__30062);
} else {
return G__30062;
}
})();
...
return cljs.core.vary_meta.call(null,G__30065,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__30069 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__30069) {
...
var vec__30074 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__30074,(0),null);
var types = vec__30074;
...
return cljs.core.map.call(null,(function (p__30086){
var vec__30087 = p__30086;
var ns = cljs.core.nth.call(null,vec__30087,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__30087,(1),null);
return ((function (vec__30087,ns,vars__$1){
return (function (){
...
var G__30090 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__30090) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1){
return (function (){
var seq__30091 = cljs.core.seq.call(null,vars__$1);
var chunk__30092 = null;
var count__30093 = (0);
var i__30094 = (0);
while(true){
if((i__30094 < count__30093)){
var v = cljs.core._nth.call(null,chunk__30092,i__30094);
var temp__4657__auto___30096 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___30096)){
var t_30097 = temp__4657__auto___30096;
each_fixture_fn.call(null,((function (seq__30091,chunk__30092,count__30093,i__30094,t_30097,temp__4657__auto___30096,v,each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30097)));
});})(seq__30091,chunk__30092,count__30093,i__30094,t_30097,temp__4657__auto___30096,v,each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1))
);
} else {
}

var G__30098 = seq__30091;
var G__30099 = chunk__30092;
var G__30100 = count__30093;
var G__30101 = (i__30094 + (1));
seq__30091 = G__30098;
chunk__30092 = G__30099;
count__30093 = G__30100;
i__30094 = G__30101;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__30091);
if(temp__4657__auto__){
var seq__30091__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__30091__$1)){
var c__27051__auto__ = cljs.core.chunk_first.call(null,seq__30091__$1);
var G__30102 = cljs.core.chunk_rest.call(null,seq__30091__$1);
var G__30103 = c__27051__auto__;
var G__30104 = cljs.core.count.call(null,c__27051__auto__);
var G__30105 = (0);
seq__30091 = G__30102;
chunk__30092 = G__30103;
count__30093 = G__30104;
i__30094 = G__30105;
continue;
} else {
var v = cljs.core.first.call(null,seq__30091__$1);
var temp__4657__auto___30106__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___30106__$1)){
var t_30107 = temp__4657__auto___30106__$1;
each_fixture_fn.call(null,((function (seq__30091,chunk__30092,count__30093,i__30094,t_30107,temp__4657__auto___30106__$1,v,seq__30091__$1,temp__4657__auto__,each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30107)));
});})(seq__30091,chunk__30092,count__30093,i__30094,t_30107,temp__4657__auto___30106__$1,v,seq__30091__$1,temp__4657__auto__,each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1))
);
} else {
}

var G__30108 = cljs.core.next.call(null,seq__30091__$1);
var G__30109 = null;
var G__30110 = (0);
var G__30111 = (0);
seq__30091 = G__30108;
chunk__30092 = G__30109;
count__30093 = G__30110;
i__30094 = G__30111;
continue;
}
} else {
...
});})(each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1))
);
});})(each_fixture_fn,G__30090,env,once_fixtures,each_fixtures,vec__30087,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1493511393256