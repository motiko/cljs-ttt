...
var G__36985 = devtools.prefs.pref.call(null,v);
v = G__36985;
continue;
} else {
return v;
...
}catch (e36998){var e__34390__auto__ = e36998;
return false;
}})();
...
}catch (e37002){var e__34390__auto__ = e37002;
return false;
}})();
...
}catch (e37004){var e__34390__auto__ = e37004;
return false;
}}
}
});
...
var vec__37009 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37009,(0),null);
var name = cljs.core.nth.call(null,vec__37009,(1),null);
...
return cljs.core.some.call(null,(function (p1__37012_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37012_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1493455000426