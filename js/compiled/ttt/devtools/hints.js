...
}catch (e37797){var _e = e37797;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___37800 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___37800)){
var seen_errors_37801 = temp__4655__auto___37800;
if(cljs.core.truth_(seen_errors_37801.has(self))){
} else {
seen_errors_37801.add(self);

var temp__4657__auto___37802 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___37802)){
var sense_37803 = temp__4657__auto___37802;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_37803)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1493455001725