...
var args34135 = [];
var len__27315__auto___34139 = arguments.length;
var i__27316__auto___34140 = (0);
while(true){
if((i__27316__auto___34140 < len__27315__auto___34139)){
args34135.push((arguments[i__27316__auto___34140]));

var G__34141 = (i__27316__auto___34140 + (1));
i__27316__auto___34140 = G__34141;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34135.length)].join('')));
...
var G__34138 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__34138,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__34138;
}
});
...
var len__27315__auto___34146 = arguments.length;
var i__27316__auto___34147 = (0);
while(true){
if((i__27316__auto___34147 < len__27315__auto___34146)){
args__27322__auto__.push((arguments[i__27316__auto___34147]));

var G__34148 = (i__27316__auto___34147 + (1));
i__27316__auto___34147 = G__34148;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq34143){
var G__34144 = cljs.core.first.call(null,seq34143);
var seq34143__$1 = cljs.core.next.call(null,seq34143);
var G__34145 = cljs.core.first.call(null,seq34143__$1);
var seq34143__$2 = cljs.core.next.call(null,seq34143__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__34144,G__34145,seq34143__$2);
});
...
var map__34152 = m;
var map__34152__$1 = ((((!((map__34152 == null)))?((((map__34152.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34152.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34152):map__34152);
var file = cljs.core.get.call(null,map__34152__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34152__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34152__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__34152,map__34152__$1,file,line,column){
return (function (p1__34149_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__34149_SHARP_));
});})(map__34152,map__34152__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__27165__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__26240__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__26240__auto__)){
return or__26240__auto__;
} else {
...
var temp__4657__auto___34154 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___34154)){
var message_34155 = temp__4657__auto___34154;
cljs.core.println.call(null,message_34155);
} else {
}
...
var temp__4657__auto___34156 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___34156)){
var message_34157 = temp__4657__auto___34156;
cljs.core.println.call(null,message_34157);
} else {
}
...
var temp__4655__auto__ = (function (){var and__26228__auto__ = typeof exception.stack === 'string';
if(and__26228__auto__){
var G__34167 = exception.stack;
var G__34167__$1 = (((G__34167 == null))?null:clojure.string.split_lines.call(null,G__34167));
var G__34167__$2 = (((G__34167__$1 == null))?null:cljs.core.get.call(null,G__34167__$1,depth));
if((G__34167__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__34167__$2);
}
} else {
...
var vec__34168 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__34168,(0),null);
var column = cljs.core.nth.call(null,vec__34168,(1),null);
var vec__34171 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__34171,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__34171,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__34171,(2),null);
...
var m__$1 = (function (){var G__34175 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__34175) {
case "fail":
...
var G__34181 = (function (){var G__34180 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__34180);
} else {
return G__34180;
}
})();
...
return cljs.core.vary_meta.call(null,G__34183,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__34187 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__34187) {
...
var vec__34192 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__34192,(0),null);
var types = vec__34192;
...
return cljs.core.map.call(null,(function (p__34204){
var vec__34205 = p__34204;
var ns = cljs.core.nth.call(null,vec__34205,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__34205,(1),null);
return ((function (vec__34205,ns,vars__$1){
return (function (){
...
var G__34208 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__34208) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1){
return (function (){
var seq__34209 = cljs.core.seq.call(null,vars__$1);
var chunk__34210 = null;
var count__34211 = (0);
var i__34212 = (0);
while(true){
if((i__34212 < count__34211)){
var v = cljs.core._nth.call(null,chunk__34210,i__34212);
var temp__4657__auto___34214 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___34214)){
var t_34215 = temp__4657__auto___34214;
each_fixture_fn.call(null,((function (seq__34209,chunk__34210,count__34211,i__34212,t_34215,temp__4657__auto___34214,v,each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34215)));
});})(seq__34209,chunk__34210,count__34211,i__34212,t_34215,temp__4657__auto___34214,v,each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1))
);
} else {
}

var G__34216 = seq__34209;
var G__34217 = chunk__34210;
var G__34218 = count__34211;
var G__34219 = (i__34212 + (1));
seq__34209 = G__34216;
chunk__34210 = G__34217;
count__34211 = G__34218;
i__34212 = G__34219;
continue;
} else {
...
var c__27051__auto__ = cljs.core.chunk_first.call(null,seq__34209__$1);
var G__34220 = cljs.core.chunk_rest.call(null,seq__34209__$1);
var G__34221 = c__27051__auto__;
var G__34222 = cljs.core.count.call(null,c__27051__auto__);
var G__34223 = (0);
seq__34209 = G__34220;
chunk__34210 = G__34221;
count__34211 = G__34222;
i__34212 = G__34223;
continue;
} else {
var v = cljs.core.first.call(null,seq__34209__$1);
var temp__4657__auto___34224__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___34224__$1)){
var t_34225 = temp__4657__auto___34224__$1;
each_fixture_fn.call(null,((function (seq__34209,chunk__34210,count__34211,i__34212,t_34225,temp__4657__auto___34224__$1,v,seq__34209__$1,temp__4657__auto__,each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34225)));
});})(seq__34209,chunk__34210,count__34211,i__34212,t_34225,temp__4657__auto___34224__$1,v,seq__34209__$1,temp__4657__auto__,each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1))
);
} else {
}

var G__34226 = cljs.core.next.call(null,seq__34209__$1);
var G__34227 = null;
var G__34228 = (0);
var G__34229 = (0);
seq__34209 = G__34226;
chunk__34210 = G__34227;
count__34211 = G__34228;
i__34212 = G__34229;
continue;
}
} else {
...
});})(each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1))
);
});})(each_fixture_fn,G__34208,env,once_fixtures,each_fixtures,vec__34205,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1493454996358